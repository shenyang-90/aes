...
| **日期** | 2026-04-02 |
| **作者** | IP Architect |
| **状态** | Updated - EDR Minor Issues Fixed |
| **评审** | AI Yang (Quality Gatekeeper) |
| **ASIL** | ASIL-D |
| **变更** | 修复EDR Minor Issues: XTS运算符定义、面积置信区间、L3门控逻辑、PVT条件、专利细节 |
...
| v1.0 | 2026-04-01 | 新增双核锁步架构: <br> - 更新顶层架构图 (双核锁步) <br> - 更新寄存器映射 (DUAL_RAIL_EN, FAULT 相关位) <br> - 更新模块划分表 (条件实例化说明) <br> - 更新功能安全章节 (可配置安全策略) <br> - 更新性能指标 (Lockstep 模式对比) | Design Agent |
| v1.1 | 2026-04-02 | 修复EDR Minor Issues: <br> - **m16**: 明确XTS公式⊗为GF(2^128)乘法定义 <br> - **m17**: 模块面积估算增加置信区间 (90%置信水平) <br> - **m18**: 新增7.2节详细描述L3级时钟门控使能逻辑 <br> - **m19**: 功耗指标补充完整PVT条件 (TT/FF/SS corner) <br> - **m20**: 新增10.1节专利申请技术点详细描述 (3个专利点) | IP Architect |
